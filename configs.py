...
config_mnist['print_every'] = 10 #1560
...
config_mnist['e_nlayers'] = 3
config_mnist['e_nfilters'] = 256

config_mnist['d_arch'] = 'mlp' # mlp, dcgan, dcgan_mod, ali, began
config_mnist['d_nlayers'] = 3
config_mnist['d_nfilters'] = 256
