...
def Batchnorm_contrib(opts, _input, scope=None, is_training=False, reuse=None, scale=True, center=True, fused=False):
    """Batch normalization based on tf.contrib.layers.

    """
    return tf.contrib.layers.batch_norm(
        _input, center=center, scale=scale,
...
def Batchnorm_layers(opts, _input, scope=None, is_training=False, reuse=None, scale=True, center=True, fused=False):
