...
def main():
    ...
    # Model set up
    opts['nlatents'] = 10
    opts['zdim'] = [52, 48, 44, 40, 36, 32, 28, 24, 20, 16]
    ...
    opts['e_nfilters'] = [96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96]
    ...
    opts['d_nfilters'] = [96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96]
