...
def main():
    ...
    lmba1 = [0.0005, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5]
    ...
    opts['lambda_pen_enc_sigma'] = [2. / (4.5**i) for i in range(opts['nlatents'])]
    ...
    opts['e_nfilters'] = [64, 96, 96, 96, 128, 128]
    ...
    opts['d_nfilters'] = [64, 96, 96, 96, 128, 128]
