...
from loss_functions import Xentropy_penalty, entropy_penalty, kl_penalty, vae_sigmoid_reconstruction_loss, moments_loss
    ...
    def __init__(self, opts):
        ...
        for n in range(opts['e_nlatents']):
            ...
            if n==0:
                ...
                # matching penalty (KL)
                self.match_penalty -= Xentropy_penalty(self.encoded[-2],dec_mean,dec_Sigma)
